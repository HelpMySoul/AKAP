...
object TopMenuManager {
    ...
    fun loadPlaylistButton(context: Context, fragmentManager: FragmentManager, containerId: Int): TopMenuButton {
        return TopMenuButton(context.getString(R.string.Current_playlist_S)) {
    ...
    fun loadButtons(context: Context, fragmentManager: FragmentManager, containerId: Int): List<TopMenuButton> {
        return listOf(
            ...
            TopMenuButton(context.getString(R.string.Recommendations_S)) {
                switchScreen(context, fragmentManager, containerId, Recommendations())
            },
            TopMenuButton(context.getString(R.string.Settings_S)) {
                switchScreen(context, fragmentManager, containerId, Settings())
            },
